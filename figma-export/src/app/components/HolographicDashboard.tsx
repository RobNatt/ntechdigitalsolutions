...
const tabs = [
  ...
  { id: 'neural', label: 'Neural Net', icon: Brain },
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">QUANTUM INTERFACE v12.5.8</p>
              </div>
            </div>
            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  <Icon className={`w-5 h-5 relative z-10 ${isActive ? 'text-gray-700' : 'text-gray-600'}`} />
                  <span className={`relative z-10 ${isActive ? 'text-gray-700' : 'text-gray-600'}`}>
                    {tab.label}
                  </span>
                  {isActive && (
                    <motion.div
