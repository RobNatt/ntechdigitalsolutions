...
3. **`supabase/migrations/006_leads_company_id_nullable.sql`** — **CRITICAL**: makes company_id nullable. Without this, lead form submissions return 500 (null value in column "company_id" violates not-null constraint).
