-- Add explicit date-range support for dashboard analytics
-- Keeps existing behavior semantics but constrains queries to [p_since, p_until].
...
REVOKE ALL ON FUNCTION public.analytics_get_summary(uuid, timestamptz, timestamptz) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.analytics_get_summary(uuid, timestamptz, timestamptz) TO service_role;
