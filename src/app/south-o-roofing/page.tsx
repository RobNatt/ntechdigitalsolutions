...
import { SouthOContactSection } from "@/components/south-o-roofing/south-o-contact-section";
import { SouthOFooter } from "@/components/south-o-roofing/south-o-footer";
import { SouthOHeader } from "@/components/south-o-roofing/south-o-header";
...
/** Project photos in /public (excludes logo & non-project assets). */
const GALLERY_ITEMS = [
  {
    src: "/hero1.jpg",
...
const TESTIMONIALS = [
  {
    quote:
      "We had some storm damage and met Byron from South O Roofing through a neighbor's recommendation. To make a long story short, we had a great experience. They worked well with our insurance company, did quality work, and our project coordinator Nicky was amazing. In fact we contracted with them to do a complete remodel of the exterior of our home. This company is honest and reliable. I highly recommend them.",
    date: "4 months ago",
    name: "Geoff Sager",
    location: "Omaha, NE",
  },
  {
    quote:
      "South O roofing made getting our roof done simple and easy- they dealt with my insurance on what they needed which made it hassle free for me. They came at about 630/7am  and were gone by 5pm by the time i got home from work and were completely done with the roof! Thank you!",
    date: "2 months ago",
    name: "Sarah Wetzel",
    location: "Omaha, NE",
  },
  {
    quote:
      "Had South O Roofing installed windows for us, we are very satisfied w their work & warmer too lol. Weather was a factor but that didn't stop them from freezing as they installed our windows. Looks 100% better inside and out! Very thankful to the crew for their help upgrading our home. Stayed true to their word & our budget & will definitely recommend this business to others. Thanx again to South O Roofing.",
    date: "Recently",
    name: "Tracy Hanson",
    location: "Omaha, NE",
  },
  ...
  {
    quote:
      "Eddie and South O Roofing team have been amazing to work with! They managed everything with the insurance company with ease, communicated well throughout process, and I ended up with a beautiful new roof and gutters. I recommend highly and would use again if ever needed.",
    date: "9 months ago",
    name: "Brooke Evans",
    location: "Papillion, NE",
  },
  {
    quote: `I had the pleasure of working with Eddie Jones and South O Roofing after having storm damage to both roof and siding.  This salesman and the office help were wonderful in guiding me to make decisions on products and handled all information with my insurance company putting me at ease on what to do.  His original comment to me was "I've got you " and he lived up to that for sure.  Highly recommend for one-stop help for storm damage.`,
    date: "11 months ago",
    name: "Carol Jensen",
    location: "Omaha, NE",
  },
...
export const metadata: Metadata = {
  title: "South-O Roofing",
  description:
    "South-O Roofing serves Omaha, Lincoln, and greater Nebraska — residential & commercial roofing, repairs, inspections, and storm restoration.",
};

export default function SouthORoofingPage() {
  return (
          ...
          <div className="mx-auto w-full max-w-6xl">
            <div className="max-w-2xl text-left">
              ...
              <h1 className="mt-5 text-4xl font-semibold leading-[1.1] tracking-tight text-white sm:text-5xl md:text-6xl lg:text-[3.35rem]">
                <span className="block">South-O Roofing,</span>
