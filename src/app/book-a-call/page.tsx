 ...
 * The SMS consent checkboxes live in GoHighLevel on the form itself, not here.
 *
 ...
 *
 * This form was removed between 6 and 11 September 2026 while A2P 10DLC
 * registration was under review, because exactly one thing on the site was
 * allowed to collect visitor information during that window and the chat widget
 * was the one kept. Registration came back green, so it's restored.
 */
        ...
        <div className="mx-auto max-w-[860px]">
          ...
          <p className="mx-auto mt-8 max-w-[60ch] text-center text-small text-muted-foreground">
            ...
            <a
              ...
              className="inline-flex min-h-[24px] items-center text-foreground underline underline-offset-4"
            >
